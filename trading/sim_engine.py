"""Crypto.com Simulation Engine — multi-strategy orchestration layer.
...
logger = logging.getLogger("openclaw.trading.sim_engine")

_STATE_FILE    = Path(__file__).parent.parent / "data" / "sim_state.json"
    ...
    def _scan(self) -> None:
        ...
        for symbol in SYMBOLS:
            ...
            for sig in signals:
                ...
                from trading.strategies import StrategyStats as _SS
...
BloFinBot = BloFinBot  # noqa: F811 — name unchanged, file renamed
