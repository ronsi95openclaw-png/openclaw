...
**Last updated:** 2026-05-28 03:46 UTC (by scripts/generate_session_compact.py)
...
fbf632b Windows compat: fcntl shim + silence Sheets missing-creds noise
8619f37 Audit fixes: /livecheck WR bar, webhook duplicate-response, get_bot double-init
```
